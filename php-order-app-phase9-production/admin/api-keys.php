...
<div class="card"><form method="post" class="row"><input type="hidden" name="action" value="create"><input name="label" placeholder="Key label"><button type="submit">Create API Key</button></form></div>
